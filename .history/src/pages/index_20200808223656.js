...
const WordsContainer = () => {
  return (
    <Fade direction="bottom" duration={3000}>
      ...
      >
        <Valores
          className="grid items-center md:flex md:flex-col justify-center text-left md:items-end "
          valores={[
            "Estanques",
        ...
        <Valores
          className=" grid items-center md:flex md:flex-col justify-center text-right md:items-start"
          valores={[
            "Puentes",
            "Ciclovias",
            "Pasos sobrenivel",
