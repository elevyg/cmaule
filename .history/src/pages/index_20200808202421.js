...
const IndexPage = () => (
  <Layout>
    ...
    <Hero />
    <ValoresContainer />
    <div className="h-auto flex bg-gray-300 text-gray-900 shadow-sm">
      <div className="flex flex-col justify-center items-center m-5 bg-gray-100">
        <FontAwesomeIcon icon={faAward} size="5x" className="my-3" />
        <h2 className="text-center my-3 text-lg font-bold">Logo</h2>
