...
const ValoresContainer = () => {
  return (
    <Fade direction="bottom" duration={3000}>
      <div
        id="valores"
        className="flex justify-around items-center py-5 w-full flex-grow-0 "
      >
        <Valores
          className="flex flex-col text-rigth items-end"
  ...
  <div className={className}>
    {valores &&
      valores.map((valor, index) => (
        <motion.p
          key={valor}
          className=" text-lg md:text-3xl text-gray-800 font-bold "
