...
const INFO = [
  ...
  },
  {
    ...
    description: `La experiencia acumulada ejecutando obras civiles comprende múltiples especialidades, entre las cuales destacan construcción de caminos y ciclovías, puentes, pasos sobrenivel, pavimentaciones en hormigón y asfalto, estanques de acumulación enterrados y superficiales, urbanizaciones, parques, instalaciones de sistemas de evacuaciones de aguas lluvia, aguas servidas, suministro y distribución de agua potable, plantas de tratamiento, impulsión y recolección de aguas servidas, sistemas de control y fuerza, alumbrado público, entre otros.`,
  },
]
const InfoContainer = () => {
  return (
