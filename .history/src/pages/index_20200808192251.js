    ...
    {valores &&
      valores.map((valor, index) => (
        <div className="flex relative">
          <motion.div
            className="h-20 w-20 absolute bg-dark-blue rounded-full z-20"
            style={
              index === 0
          ...
          >
            <motion.div
              className="h-32 w-32 absolute bg-yellow-400 rounded-full "
              style={
                index === 0
          ...
          <motion.p
            key={valor}
            className=" text-xl md:text-5xl my-12 relative top text-gray-500"
