...
const COLORES = ["#5e5874", "#1d3d82", "#fcb501", "#5e5874", "#1d3d82"]
...
const WordsContainer = () => {
  return (
    <Fade direction="bottom" duration={3000}>
      ...
      >
        <Valores
          className="grid text-center md:flex md:flex-col justify-center md:text-left md:items-end "
          valores={[
            "Estanques",
        ...
        <Valores
          className=" grid text-center md:flex md:flex-col justify-center md:text-right md:items-start"
          valores={[
            "Puentes",
            "Ciclovias",
            "Pasos sobrenivel",
...
const Valores = ({ valores, className }) => (
  <Fade direction="top" className={className}>
    {valores &&
