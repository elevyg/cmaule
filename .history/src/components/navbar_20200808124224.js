...
import { useElementScroll, motion, useViewportScroll } from "framer-motion"
...
const Navbar = ({ siteTitle }) => {
  ...
  return (
    <div ref={ref}>
      <motion.header
        id="navbar"
        initial={{ backgroundColor: "rgba(0, 0, 102, 0)" }}
        style={{
          backgroundColor: `rgba(0, 0, 102,${scrollY.updateAndNotify})`,
        }}
